...
source(paste(wd, "2_AnalisisCoexWGCNA.R", sep = "/"))

####CONSTRUCCIÓN RED TOPOLÓGICA#####


############################## ESTÁ EN "2_AnalisisCoexWGCNA.R" ##########################3
#enableWGCNAThreads()
...
pdf(file = "3_Gene_clustering_on_TOM-based_dissimilarity.pdf", width = 12, height = 9)
...
setwd(results)
pdf(file = "4_Dynamic_Tree_Cut.pdf", width = 8, height = 6)
...
setwd(results)
pdf(file = "5_Clustering_of_module_eigengenes.pdf", width = 7, height = 6)
