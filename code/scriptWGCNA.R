...
resultsDir<-setwd("C:/Users/Ana/Desktop/Uni/PrimerCuatri/Biolog韆Sist/TRABAJOFINAL/project_template_BS_SARS-CoV2/results")
workingDir<-setwd("C:/Users/Ana/Desktop/Uni/PrimerCuatri/Biolog韆Sist/TRABAJOFINAL")
getwd()
#
library(ggplot2)
library(factoextra)
...
#Aqu铆 lo que hacemos es observar para seleccionar loe genes coexpresados  deferenciales seg煤n el analisis
#de red de coexpresi贸n generica ponderada (WGCNA)
...
names(Links)
#Links$rth contienen los dos umbrales de correlaci贸n para ambas condiciones;
#Ambos Links$cor.filtered. mantienen las matrices de correlaci贸n filtradas para las condiciones A y B.
#Vemos los umbrales de correlaci贸n:
...
####POR LO QUE PODEMOS LLEGAR A LA CONCLUSI脫N QUE LOS QUE DEL CLUSTER 1 DEBEMOS USAR LA EXPRESION 3 
...
#TOM = Matriz de superposici贸n topol贸gica (aclaracion)
plotTOM <- dissTOM^7
...
setwd("C:/Users/Ana/Desktop/Uni/PrimerCuatri/Biolog韆Sist/TRABAJOFINAL/project_template_BS_SARS-CoV2/results")
getwd()
cor_pearson <- createNet(expData = dataC,threshold = 0.99,method = "correlation")
plot(cor_pearson)
jpeg(plot(cor_pearson),"cor_pearson.jpg")
dev.off()
setwd("C:/Users/Ana/Desktop/Uni/PrimerCuatri/Biolog韆Sist/TRABAJOFINAL")
getwd()
