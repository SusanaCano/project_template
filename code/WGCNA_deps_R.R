...
if(!require(installr)) {
  install.packages("installr", repos = 'http://cran.us.r-project.org',  lib = "software_deps")
  require(installr)
} 
...
library("installr", repos = 'http://cran.us.r-project.org',  lib = "software_deps")
...
if (!requireNamespace ("BiocManager", quietly = TRUE)) 
  ...
  install.packages("BiocManager", repos = 'http://cran.us.r-project.org', lib = "software_deps")

BiocManager::install(c("RTCGAToolbox", "WGCNA", "DESeq2", "coexnet")) 
# "D:/uni/2020-21/BiologiaSistemas/Practicas/Aurelio/trabajoFinal/Git/project_template_BS_SARS-CoV2/code/software/deps"
...
install.packages("NbClust", repos = 'http://cran.us.r-project.org',  lib = "software_deps")
...
install.packages("tidyverse ", repos = 'http://cran.us.r-project.org',  lib = "software_deps")
###########################################################
